...
if __name__ == '__main__':
    ...
    resource = [
                 {"hostname": "10.20.0.3", "port": "22", "username": "root", "password": "r00tme"},
                 {"hostname": "10.20.0.4", "port": "22", "username": "root", "password": "r00tme"},
                 {"hostname": "10.20.0.5", "port": "22", "username": "root", "password": "r00tme"}
               ]

    rbt = ANSRunner(resource)  #resource可以是列表或者字典形式，如果做了ssh-key认证，就不会通过账户密码方式认证
    rbt.run_model(host_list=["10.20.0.3","10.20.0.4","10.20.0.5"],module_name='setup',module_args="")
